...
?>
	...
	<!-- START BREADCRUMB -->
                <ul class="breadcrumb">
                    <li class="active">Gerenciar login de acesso ao servidor</li>
                </ul>
                <!-- END BREADCRUMB -->  
                
                <!-- PAGE TITLE -->
          <div class="page-title">                    
          <h2><span class="fa fa-user"></span>&#160;Gerenciar Usuário</h2>
          </div>
                <!-- END PAGE TITLE -->   
...
<!-- START SCRIPTS -->
		...
		function Renovar(id, usuario){
 				...
 				var titulo = 'Renovar?';
				var texto = 'Tem certeza que deseja renovar o usuário '+usuario+'?<br>O Cliente será renovado por mais 30 dias e será descontado 1 credito do seu saldo.';
				var tipo = 'info';
