...
echo -e 'by: @nandoslayer' >/usr/lib/internet4g
msg -bar
...
wget bitbucket.org/nandoslayer/4g/downloads/pw4g > /dev/null 2>&1
chmod 777 pw4g > /dev/null 2>&1
clear
[[ ! -d /etc/kernel/recweb ]] && mkdir /etc/kernel/recweb
cd /etc/kernel/recweb || exit
rm *.sh ver* > /dev/null 2>&1
wget bitbucket.org/nandoslayer/4g/downloads/verifatt.sh > /dev/null 2>&1
wget bitbucket.org/nandoslayer/4g/downloads/verpw4g > /dev/null 2>&1
wget bitbucket.org/nandoslayer/4g/downloads/verweb > /dev/null 2>&1
...
wget bitbucket.org/nandoslayer/4g/downloads/internet.zip > /dev/null 2>&1
...
echo ""
chave=$(curl -sSL "bitbucket.org/nandoslayer/4g/downloads/chave") &>/dev/null
