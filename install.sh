...
soft="python bc screen at unzip zip sqlite3 lsof netstat net-tools dos2unix nload jq python3 python-pip"
for i in $soft; do
leng="${#i}"
puntos=$((21 - $leng))
pts="."
...
apt install php7.4 libapache2-mod-php7.4 php7.4-xml php7.4-mcrypt php7.4-sqlite3 php-7.4-zip php7.4-curl php7.4-mbstring php7.4-cli php7.4-common php7.4-xmlrpc php7.4-gd php7.4-imagick php7.4-dev php7.4-imap php7.4-opcache php7.4-soap php7.4-zip php7.4-intl -y > /dev/null 2>&1
systemctl restart apache2 > /dev/null 2>&1
