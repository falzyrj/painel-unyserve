...
<div class="page-sidebar">
                ...
                <ul class="x-navigation">
                    <li class="xn-logo">
                        <a href="index.php"><span>Painel4G</span></a>
                    ...
                    <?php
                     ...
                     <li>
                        <a href="index.php?p=usuario"><span class="fa fa-users"></span> <span class="xn-text">Gerenciar Usuário</span></a>
                    </li>
                    
                    <li>
                        <a href="index.php?p=criar-teste"><span class="fa fa-users"></span> <span class="xn-text">Criar teste</span></a>
                    </li>
                    
                    <li>
                        <a href="index.php?p=online"><span class="fa fa-circle"></span> <span class="xn-text">Usúario online</span></a>
                    </li>
					...
					?>
					 <li>
                        <a class="pointer" onclick="AlterarOperadora();"><span class="fa fa-circle-o"></span> <span class="xn-text">Alterar Servidor</span></a>
                    </li>
                    <li class="xn-openable">
