...
exit;
  ...
  echo -e 'Nunca Desista dos seus sonhos.' >/usr/lib/internet4g
  msg -bar
...
if [[ -e "/var/www/html/bdpainel.sql" ]]; then
    mysql -h localhost -u root -p"$pwdroot" --default_character_set utf8 sshplus < /var/www/html/bdpainel.sql > /dev/null 2>&1
...
echo -e "\033[1;33m MAIS INFORMAÇÕES \033[1;31m(\033[1;36mTELEGRAM\033[1;31m): \033[1;37m@UNYSERVE\033[0m" | lolcat
echo ""
